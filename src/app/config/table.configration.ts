...
export class agCofigrations {
  ...
  public GridDataSurce(filter: any, surce: any, fuction: any) {
    this.filter = filter;
    this.surce = surce;
      ...
      requst
        .subscribe({
          next: (res: any) => {
            ...
            this.PagenationData = Object.assign({}, res);
  ...
  setPageText() {
    document.getElementsByClassName("ag-paging-row-summary-panel")[0].innerHTML = `<p class="p-font fw-bold">${this.PagenationData.totalItems} : إجمالي النتائج</p>`;
